                    ...
                    <div class="navbar-brand">
                        <a href="index.html" class="logo">
                            ...
                            <span class="logo-text">
                                <img src="../assets/images/logo-light-text.png" class="light-logo" alt="homepage" style="margin-left:10px;width:140px;height:15px;" />
                            </span>
                        </a>
                    </div>
                    ...
                    <ul class="navbar-nav float-right">
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated">
                                ...
                                <a class="dropdown-item" href="../../index.php"><i class="ti-agenda m-r-5 m-l-5"></i> My Website</a>
                                <a class="dropdown-item" href="#"><i class="ti-wallet m-r-5 m-l-5"></i> Logout</a>
                            </div>
                        </li>
                    </ul>
                </div>
